...
and right-click the class "Application" and select the option "Run Application.main()" wait until the application has started. The log entries should be error free and the last entries should show something similar to the below with the application hosted by Tomcat at port 8080,  
